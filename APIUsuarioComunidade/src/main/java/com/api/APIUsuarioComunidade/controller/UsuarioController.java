...
//	@PostMapping("login")
//	public ResponseEntity<UsuarioDTO> select(@RequestBody @Valid Usuario usuario) {
//
//		Optional<Usuario> usuarioBD = repository.findById(usuario.getId());
//		if (usuarioBD != null) {
//			if (usuarioBD.get().getSenha().equals(usuario.getSenha())) {
//				System.out.println("Encontrou e Validou Senha: ");
//				return ResponseEntity.ok(UsuarioConverter.toDTO(usuarioBD.get()));
//			}
//
//			else {
//				System.out.println("Encontrou e NÃO Validou Senha: ");
//				return ResponseEntity.notFound().build();
//			}
//
//		}
...
//	}
	...
	public ResponseEntity<String> login(@RequestBody Usuario usuario) {
		...
		if (usuario != null && passwordService.matches(usuario.getSenha(), u.getSenha())) {
